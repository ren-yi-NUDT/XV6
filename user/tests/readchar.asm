...
user/tests/_readchar:     file format elf64-littleriscv
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e4:	62850513          	addi	a0,a0,1576 # a08 <digits>
 3e8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ea:	4ca70713          	addi	a4,a4,1226 # 9b0 <malloc+0x15a>
 ...
 576:	496b8b93          	addi	s7,s7,1174 # a08 <digits>
 ...
 5cc:	3e090913          	addi	s2,s2,992 # 9a8 <malloc+0x152>
        while(*s != 0){
...
morecore(uint nu)
{
 ...
 836:	07c1                	addi	a5,a5,16 # 1010 <digits+0x608>
 838:	853e                	mv	a0,a5
