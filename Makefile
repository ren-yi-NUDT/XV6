...
$K/kernel: $(OBJS) $K/kernel.ld $U/initcode Makefile
...
fs.img: mkfs/mkfs README $U/tests/cmds.sh $(UPROGS) Makefile
	mkfs/mkfs fs.img README $U/tests/cmds.sh $(UPROGS)
...
QEMUOPTS += -drive file=/home/$(USER)/fs.img,if=none,format=raw,id=x0
